...
* Download the reference genome data ([instructions](ref/README.md), [script 01-reference_download.sh](ref/01-reference_download.sh))
* Download the sample BAMS ([instructions](data/README.md), [script 01-data_download.sh](data/01-data_download.sh)) 
* Run VarScan2 ([script 02-run_varscan.sh](data/02-run_varscan.sh))
